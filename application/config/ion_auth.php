...
*/
	 ...
	 * Tables.
	 **/
	$config['tables']['groups']          = 'piano_user_groups';
	$config['tables']['users']           = 'piano_backend_users';
	$config['tables']['users_groups']    = 'piano_users_groups';
	
	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "Swahili Music Notes";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@swahilimusicsheet.com";
